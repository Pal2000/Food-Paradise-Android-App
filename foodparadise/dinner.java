...
public class dinner extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener  {
    private DrawerLayout drawer;
    //final GlobalClass globalVariable = (GlobalClass) getApplicationContext();
    Button b1,b2,b3,b4,b5,b6,b7,b8, proceed;
    TextView et;
    int prices[]={450,350,250,110,200,190,500,230};
...
//                    Toast.makeText(breakfast.this, sum, Toast.LENGTH_SHORT).show();
        ...
        proceed.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                //int total=Integer.parseInt(et.getText().toString());
                if(total == 0){
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(dinner.this, drawer,toolbar, R.string.navigation_drawer_open,R.string.navigation_drawer_close);
