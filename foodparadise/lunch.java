...
public class lunch extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener  {
...
//                    Toast.makeText(breakfast.this, sum, Toast.LENGTH_SHORT).show();
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(lunch.this, drawer,toolbar, R.string.navigation_drawer_open,R.string.navigation_drawer_close);
